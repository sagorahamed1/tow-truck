...
class _TripScreenState extends State<TripScreen> {
  ...
  getApiData() {
    if (selectedBtnIndex == 0) {
      ...
      towTruckJobController.jobCompleted.value = [];
      towTruckJobController.getCompletedJob();
    }
  }
          ...
          children: [
            ...
            selectedBtnIndex == 0
                      ...
                      () => towTruckJobController.userRequestLoading.value
                          ...
                          : towTruckJobController.userRequest.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemCount:
                                      towTruckJobController.userRequest.length,
                                  itemBuilder: (context, index) {
                                    var userJob = towTruckJobController
                                        .userRequest[index];
                                    counter.value =
                                        userJob.amount?.toInt() ?? 0;
                                    return Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            //     GestureDetector(
                                            //       onTap: () {
                                            //         towTruckJobController.cancelJobs(jobId: userJob.jobId.toString());
                                            //       },
                                            //       child: Container(
                                            //           decoration: BoxDecoration(
                                            //               color: Colors.transparent,
                                                      ...
                                                      : (userJob.negBy ==
                                                          ...
                                                          ? Container(
                                                              ...
                                                              child: Center(
                                                                  child: CustomText(
                                                                      text:
                                                                          "You already request to ${profileController.role == "user" ? "Provider" : "User"}",
                                                                      color: Colors
                                                                          .white)))
                                                          : Row(
                                                              children: [
                                                                  ...
                                                                  () => CustomButtonTwo(
                                                                      ...
                                                                      onpress: () {
                                                                        towTruckJobController.acceptJob(
                                                                            jobId:
                                                                                userJob.jobId.toString(),
                                                                            providerId: userJob.userId,
                                                                            trxId: userJob.trId,
                                                                            context: context);
                                                                      }),
                                                                )
                ...
                : selectedBtnIndex == 1
                    ? Expanded(
                        child: Obx(
                          () => towTruckJobController.ongoingLoading.value
                              ? CustomLoader()
                              : towTruckJobController.jobOngoing.isEmpty
                                  ...
                                  : selectedBtnIndex == 0
                                      ? ListView.builder(
                                          itemCount: towTruckJobController
                                              .jobOngoing.length,
                                          padding: EdgeInsets.only(top: 8.h),
                                          itemBuilder: (context, index) {
                                            var job = towTruckJobController
                                                .jobOngoing[index];
                    ...
                    : Expanded(
                        child: Obx(() => towTruckJobController
                                .completedLoading.value
                            ? CustomLoader()
                            : towTruckJobController.jobCompleted.isEmpty
                                ? Center(
                                    child: Assets.images.noDataImage.image(),
                                  )
                                : ListView.builder(
          ...
          Row(
            children: [
              Expanded(
                child: CustomText(
                  text:
                      "${TimeFormatHelper.formatDate(dateTime ?? DateTime.now())}, ${TimeFormatHelper.timeWithAMPM(dateTime ?? DateTime.now())}",
                  fontSize: 14.sp,
